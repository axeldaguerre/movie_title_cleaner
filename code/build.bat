...
cl %CommonCompilerFlags% ..\code\purificator.cpp -Fmpurificator.map -LD /link -incremental:no -opt:ref -PDB:purificator.pdb -EXPORT:GetMovieData -EXPORT:CleanFileMovie -EXPORT:AskPickMovies -EXPORT:DEBUGCheckUserPicksFile -EXPORT:ShowFilesFailed
